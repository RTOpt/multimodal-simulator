...
#SBATCH --output=python/examples/fixed_line/test_files_multi_high_frequency/slurm_output_%A_%a.out
#SBATCH --error=python/examples/fixed_line/test_files_multi_high_frequency/slurm_error_%A_%a.err
#SBATCH --array=0-11  # 12 tasks for 12 test files
...
BASE_DIR="python/examples/fixed_line/test_files_multi_high_frequency"

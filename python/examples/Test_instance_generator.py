...
def generate_test_instance(date: str,
    ...
    selected_trip_ids = pd.read_csv(os.path.join(output_path, "trips.txt"))['trip_id'].unique()
    trip_ids = filter_requests(date, selected_trip_ids,"TestInstance", base_path)
...
if __name__ == "__main__":
    date = "2019-11-01"
    #start time = 8:26:40 AM
    start_time = 30400
    route_ids = ['17N', '151N', '26O', '42E','56O']
    # generate_duration_test_instance('TestInstanceDurationShort_NEW','gtfs'+date, start_time, 1200)  # 20 minutes
    ...
    route_ids = ['24E', '17S', '151S', '56E', '42O']

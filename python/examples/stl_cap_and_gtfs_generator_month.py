...
if __name__ == '__main__':
    ...
    for dateshort in dates:
        ...
        stop_times_filepath = os.path.join(date_folder, "stop_times_upgrade.txt")
        trips_filepath = os.path.join(date_folder, "trips.txt")
        requests_savepath = os.path.join(date_folder, "requests.csv")
        connections_savepath = os.path.join(date_folder, "available_connections.json")
        ...
        # Save to file
        print('Saving requests to: ', args.requests)

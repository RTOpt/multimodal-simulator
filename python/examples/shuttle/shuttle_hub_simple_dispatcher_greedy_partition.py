...
from multimodalsim.optimization.partition import GreedyPartition
...
if __name__ == '__main__':
    ...
    vehicles_file_path = "../../../data/shuttle/simple_dispatcher/vehicles_medium.csv"
    ...
    dispatcher = ShuttleHubSimpleDispatcher(travel_time=3000)

    # Create a greedy partition made up of 2 subsets.
    partition = GreedyPartition(nb_subsets=2)

    # OneLegSplitter is used by default
    opt = Optimization(dispatcher, partition=partition)

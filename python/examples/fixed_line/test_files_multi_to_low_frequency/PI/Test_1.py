...
import os
import traceback
gtfs_folder_path = os.path.join("data","fixed_line","gtfs","gtfs2019-11-"+str(25)+"-EveningRushHourto_low_frequency_PI")
requests_file_path = os.path.join(gtfs_folder_path,'requests.csv')
output_folder_name = 'gtfs2019-11-'+str(25)+'_EveningRushHour'+'_to_low_frequency'+''
routes_to_optimize_names = ['151N', '20E', '20O', '60E', '60O', '66E', '66O']
algo = 3
sp = False
ss = True
is_corridor = False

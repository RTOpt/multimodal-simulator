...
import os
import traceback
gtfs_folder_path = os.path.join("data","fixed_line","gtfs","gtfs2019-11-"+str(25)+"-EveningRushHourgrid")
requests_file_path = os.path.join(gtfs_folder_path,'requests.csv')
output_folder_name = 'gtfs2019-11-'+str(25)+'_EveningRushHour'+'_grid'+'_SINGLE26'
routes_to_optimize_names = ['26E', '26O']
algo = 2
sp = True
ss = False
is_corridor = False

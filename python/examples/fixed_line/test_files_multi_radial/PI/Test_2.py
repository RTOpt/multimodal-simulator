...
import os
import traceback
gtfs_folder_path = os.path.join("data","fixed_line","gtfs","gtfs2019-11-"+str(25)+"-EveningRushHourradial_PI")
...
output_folder_name = 'gtfs2019-11-'+str(25)+'_EveningRushHour'+'_radial'
routes_to_optimize_names = ['33N', '33S', '37N', '37S', '39N', '39S', '65N', '65S', '70E', '70O']
algo = 3
sp = True
ss = False
is_corridor = False

...
import os
import traceback
gtfs_folder_path = os.path.join("data","fixed_line","gtfs","gtfs2019-11-"+str(25)+"-EveningRushHour151_PI")
requests_file_path = os.path.join(gtfs_folder_path,'requests.csv')
output_folder_name = 'gtfs2019-11-'+str(25)+'_EveningRushHour'+'_151'+'_SINGLE40'
routes_to_optimize_names = ['40E', '40O']
algo = 3
sp = True
ss = True
is_corridor = False

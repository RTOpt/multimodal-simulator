...
#SBATCH --array=0-5 # Dynamically adjust array range
...
nohup python ${TEST_FILES[$SLURM_ARRAY_TASK_ID]} > python/examples/fixed_line/test_files_multi/Offline/output_${SLURM_ARRAY_TASK_ID}.out 2> python/examples/fixed_line/test_files_multi/Offline/error_${SLURM_ARRAY_TASK_ID}.err

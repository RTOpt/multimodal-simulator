...
from multimodalsim.optimization.fixed_line.fixed_line_unassign_dispatcher import \
    FixedLineUnassignDispatcher
...
if __name__ == '__main__':
    ...
    gtfs_folder_path = "../../../data/fixed_line/gtfs/gtfs_reassign/"
    ...
    dispatcher = FixedLineUnassignDispatcher()

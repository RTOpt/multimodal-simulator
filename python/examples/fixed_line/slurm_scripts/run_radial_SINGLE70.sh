...
#SBATCH --output=python/examples/fixed_line/test_files_radial_SINGLE70/slurm_output_%A_%a.out
#SBATCH --error=python/examples/fixed_line/test_files_radial_SINGLE70/slurm_error_%A_%a.err
...
BASE_DIR="python/examples/fixed_line/test_files_radial_SINGLE70"

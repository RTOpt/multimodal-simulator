...
class ShuttleSimpleDispatcher(ShuttleDispatcher):

    def __init__(self, travel_time=600, hub_location="0"):
        super().__init__()
    ...
    def __assign_trip_to_route(self, trip, route, current_time):
        ...
        origin_stop_arrival_time = initial_arrival_time + self.__travel_time
        origin_stop_dict = {
        ...
        destination_stop_arrival_time = origin_stop_arrival_time + self.__travel_time
        ...
        last_stop_arrival_time = destination_stop_arrival_time + self.__travel_time
        last_stop_dict = {
